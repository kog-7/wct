...
let yesSend=function(da){
  return {
    success:true,
    data:da
  }
};
let noSend=function(err){
  return {
    success:false,
    message:err
  }
...
function sort(param1,param2){
          if(typeof param1 == "string" && typeof param2 == "string"){
            // console.log(param1.slice(0,1),param2.slice(0,1));
              return param1.slice(0,1).localeCompare(param2.slice(0,1));
          }
