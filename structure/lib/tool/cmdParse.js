...
if(!match){
  return {contentType:"",content:"",name:nameCol};
}
var colName=match[1];
if(colName==="url"){
...
return {contentType:dataType,content:content,name:name};
};
...
var type=cmdOb.type,name=cmdOb.name;
var nameArr=name.split("+");//使用+来分拆多个名字内容
var out={name:[],content:[],contentType:[],type:type};
var temp=null,tempName,tempContent,tempContentType;
...
return {core:parseTask(coreCmd),argument:parseArg(argCmd)}
}
